...
urlpatterns = [
    ...
    path('event/<slug:slug>/delete_event/<int:event_id>',views.delete_event, name='delete_event'), # delete comments
    path('event/category/<int:category_id>/', EventListByCategory.as_view(), name='events_by_category'), #Users can filter events by category id int number
