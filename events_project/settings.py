...
TEMPLATES_DIR = os.path.join(BASE_DIR, 'templates') # templates is the top level templates directory
...
# APP_DIRS is true so Django will look for a templates directory inside all apps
TEMPLATES = [
    {
